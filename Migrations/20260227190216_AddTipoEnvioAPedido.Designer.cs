...
namespace BaseConLogin.Migrations
{
    ...
    [Migration("20260227190216_AddTipoEnvioAPedido")]
    partial class AddTipoEnvioAPedido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseConLogin.Models.CarritoPersistenteItem", b =>
                {
                    ...
                    b.Property<string>("DetallesOpciones")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BaseConLogin.Models.Factura", b =>
                {
                    ...
                    b.Property<string>("TipoEnvioSeleccionado")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BaseConLogin.Models.PedidoDetallePropiedad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ValorSeleccionado")
                        .IsRequired()
                        .HasMaxLength(250)
                    ...
                    b.ToTable("PedidoDetallePropiedades");
                });
            ...
            modelBuilder.Entity("BaseConLogin.Models.ProductoPropiedadConfigurada", b =>
                {
                    ...
                    b.ToTable("ProductoPropiedadesConfiguradas", (string)null);
                });
            ...
            modelBuilder.Entity("BaseConLogin.Models.PropiedadExtendidaMaestra", b =>
                {
                    ...
                    b.Property<bool>("EsConfigurablePorDefecto")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BaseConLogin.Models.PropiedadGenerica", b =>
                {
                    ...
                    b.ToTable("PropiedadesGenericas");
                });
            ...
            modelBuilder.Entity("BaseConLogin.Models.FacturaLinea", b =>
                {
                    ...
                    b.HasOne("BaseConLogin.Models.PedidoItem", "PedidoItem")
                        .WithMany()
            ...
            modelBuilder.Entity("BaseConLogin.Models.PedidoDetallePropiedad", b =>
                {
                    b.HasOne("BaseConLogin.Models.PedidoItem", "PedidoDetalle")
                        .WithMany("PropiedadesElegidas")
            ...
            modelBuilder.Entity("BaseConLogin.Models.PedidoItem", b =>
                {
                    b.Navigation("PropiedadesElegidas");
                });
