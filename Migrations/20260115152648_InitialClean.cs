        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagenPrincipal = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosBase", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductosBase_Tiendas_TiendaId",
                        column: x => x.TiendaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosConfigurables", x => x.ProductoBaseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductoBaseId = table.Column<int>(type: "int", nullable: false),
                    ImagenPortada = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Aportaciones = table.Column<int>(type: "int", nullable: true),
                    FechaInicio = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaFin = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ArchivoPdf = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Subtitulo = table.Column<string>(type: "nvarchar(350)", maxLength: 350, nullable: false),
                    Autor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Categoria = table.Column<int>(type: "int", nullable: true),
                    Ubicacion = table.Column<int>(type: "int", nullable: true),
                    Adelanto = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: true),
                    Recompensa = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: true),
                    Calendario = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proyectos_ProductosBase_ProductoBaseId",
                        column: x => x.ProductoBaseId,
                        principalTable: "ProductosBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProyectoTags", x => new { x.ProyectoId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ProyectoTags_Proyectos_ProyectoId",
                        column: x => x.ProyectoId,
                        principalTable: "Proyectos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProyectoTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosBase_TiendaId",
                table: "ProductosBase",
                column: "TiendaId");
